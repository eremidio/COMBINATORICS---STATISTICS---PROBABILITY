//VAMOS CRIAR UM PROGRAMA PARA TESTAR AS ROTINAS CRIADAS NO ARQUIVO quicksort.hpp
//COMPILAR ESTE PROGRAMA COM O COMANDO: g++ -o quicksort quicksort.cpp
...
int main(){
  ...
  //Procedimento
    ...
    quicksort::quicksort<int>(lista, 0, n);
