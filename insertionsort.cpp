//VAMOS CRIAR UM PROGRAMA PARA TESTAR AS ROTINAS CRIADAS NO ARQUIVO bubblesort.hpp
//COMPILAR ESTE PROGRAMA COM O COMANDO: g++ -o insertionsort insertionsort.cpp
...
int main(){
  ...
  //Procedimento
    ...
    insertionsort::insertionsort<int>(lista, n);
